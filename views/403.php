   ...
   <?php require('partials/nav.php') ?>
    ...
    <main class="flex-1 flex items-center justify-center z-20">
        <div class="text-center p-10 bg-white/80 rounded-xl shadow-lg">
            <h1 class="text-5xl font-extrabold text-gray-800">Access Forbidden</h1>
            <p class="font-semibold text-gray-500 mt-4">You don’t have permission to view this page.</p>
